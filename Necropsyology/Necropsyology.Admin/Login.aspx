                            ...
                            *
                                ...
                                <div class="wrapper">
                                    <span class="group-btn">
                                        <asp:Button ID="BtnLogin" runat="server" class="BtnAceptar" OnClick="BtnLogin_Click" />
                                    </span>
                                     <span class="group-btn">
                                        <asp:Button ID="BtnRegistro" class="BtnRegistro" runat="server" CausesValidation="False" Text="Registro" OnClick="BtnRegistro_Click" />
                                    </span>
                                    <span class="group-btn">
                                        <asp:Button ID="BtnCancelar" class="BtnCancelar" runat="server" CausesValidation="False" OnClick="BtnCancelar_Click" />
                                    </span>
                                </div>
                            </div>
